...
const sidebars: SidebarsConfig = {
  ...
  tutorialSidebar: [
    ...
    {
      type: 'category',
      label: 'Chapter 4: Building ROS 2 Packages with Python',
      link: {
        type: 'doc',
        id: '04-building-ros2-packages/index',
      },
      items: [
        '04-building-ros2-packages/4.1-anatomy-of-a-ros2-package',
        '04-building-ros2-packages/4.2-creating-a-ros2-package',
        '04-building-ros2-packages/4.3-the-package-xml-manifest',
        '04-building-ros2-packages/4.4-the-setup-py-file',
        '04-building-ros2-packages/4.5-writing-a-simple-ros2-node',
        '04-building-ros2-packages/4.6-building-and-running-the-package',
        '04-building-ros2-packages/4.7-using-launch-files',
        '04-building-ros2-packages/summary',
        '04-building-ros2-packages/exercises',
      ],
    },
  ],
